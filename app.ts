...
function scanJs(js) {
    var rules = [
        ...
        {
            name: "XSS Hunter blind payload #1",
            regex: /"><script src="https:\/\//gi,
            description: "I understand this is a form :P doesn't mean you needed to do it."
        },
        {
            name: "XSS Hunter blind payload #2",
            regex: /javascript:eval\('var a=document.createElement\('script'\);a.src='https:\/\//gi,
            description: "I understand this is a form :P doesn't mean you needed to do it."
        },
        {
            name: "XSS Hunter blind payload #3",
            regex: /"><input onfocus=eval\(atob\(this\.id\)\) id=/gi,
            description: "I understand this is a form :P doesn't mean you needed to do it."
        },
        {
            name: "XSS Hunter blind payload #4",
            regex: /"><img src=x id=/gi,
            description: "I understand this is a form :P doesn't mean you needed to do it."
        },
